pro write_bias_lon_lat_matrix_as_spectral_library, input_image_filename, detector_positions_filename
...
;envi_write_envi_file, weights, file_type=envi_file_type(file_type), out_name='L8-LON_data.sli', interleave=0, ns=n_samples, nl=1, nb=1, spec_names = [case_name], bname=[case_name]


envi_write_envi_file, transposed_matrix, file_type=envi_file_type(file_type), out_name='GOES-LON_data.sli', interleave=0, ns=n_samples, nl=n_lines, nb=1, spec_names = header, bname=[case_name]
...
envi_write_envi_file, transposed_l8_matrix, file_type=envi_file_type(file_type), out_name='L8_LON_data.sli', interleave=0, ns=n_samples, nl=n_lines, nb=1, spec_names = l8_header, bname=[case_name]
